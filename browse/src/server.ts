/**
 * sage browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.sage/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.sage/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['sage browse — headless browser for AI agents', '', 'Commands:'];
