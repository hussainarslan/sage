...
1. **Check for a prior override on this branch:**
   ```bash
   source <(~/.claude/skills/sage/bin/sage-slug 2>/dev/null)
...
```bash
~/.claude/skills/sage/bin/sage-review-log '{"skill":"codex-review","timestamp":"TIMESTAMP","status":"STATUS","gate":"GATE"}'
```
