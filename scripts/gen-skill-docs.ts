...
**Project-scoped:**
\`\`\`bash
source <(~/.claude/skills/sage/bin/sage-slug 2>/dev/null) && mkdir -p ~/.sage/projects/$SLUG
\`\`\`
...
function findTemplates(): string[] {
  ...
  const candidates = [
    ...
    path.join(ROOT, 'sage-upgrade', 'SKILL.md.tmpl'),
    ...
    path.join(ROOT, 'ralph', 'SKILL.md.tmpl'),
  ];
